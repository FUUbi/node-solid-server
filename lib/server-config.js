...
function initTemplateDirs (configPath) {
  ...
  let gitInitRepositoryTemplatesPath = ensureDirCopyExists(
    path.join(__dirname, '../default-templates/new-bare-git-repository'),
    path.join(configPath, 'templates', 'bare-git-repository')
  )
  ...
  return {
    ...
    gitInit: gitInitRepositoryTemplatesPath
  }
}
